...
A string of eight 0 bits is sent from sender to reciever to mark the start and end of the message transmission. 
...
A string of 1 followed by seven 0 bits and and 
